package uniregistrar.driver.did.v1.state;

import java.util.Map;

import uniregistrar.state.RegisterStateAction;

public class RegisterStateActionDidV1TrustAnchor extends RegisterStateAction {

	public RegisterStateActionDidV1TrustAnchor(String jobid, Map<String, Object> registrarMetadata, Map<String, Object> methodMetadata, String did, String verkey, String trustAnchorUrl) {
