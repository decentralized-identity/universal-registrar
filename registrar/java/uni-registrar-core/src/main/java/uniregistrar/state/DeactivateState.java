...
public class DeactivateState {
	...
	@JsonCreator
	public static DeactivateState build(@JsonProperty(value="jobId", required=true) String jobId, @JsonProperty(value="didState", required=true) Map<String, Object> didState, @JsonProperty(value="registrarMetadata", required=true) Map<String, Object> registrarMetadata, @JsonProperty(value="methodMetadata", required=true) Map<String, Object> methodMetadata) {
